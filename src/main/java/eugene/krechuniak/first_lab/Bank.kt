...
class Bank(
    ...
    private fun timeIterator(from: Int, until: Int): Iterator<BigDecimal> {
        require(from > 0 || from <= 24) { "'від' повинно бути більше ніж 0 та менш або рівно ніж 24" }
        require(until > 0 || until <= 24) { "'доки' повинно бути більше ніж 0 та менш або рівно ніж 24" }
